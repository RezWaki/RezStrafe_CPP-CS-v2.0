...
#pragma endregion
	...
	private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 if(!semiStrafedone){
					ptre.X = scrw/2-12*12+config1+256-128; //dividing for 2 - got strafeangle
					semiStrafedone = true;
				 }
				 else{
					ptre.X = scrw/2-12*12+config1-256+128; //dividing for 2 - got strafeangle
	...
	private: System::Void timer2_Tick(System::Object^  sender, System::EventArgs^  e) {
				...
				// Sytem::Drawing::Point get;
				 ...
				 //brain exploding
				 if(!semiStrafedone){
					ptre.X = scrw/2+config1-config1+24-256+128; //dividing for 2 + got strafeangle and multiplied by 2
					semiStrafedone = true;
				 }
				 else{
					 ptre.X = scrw/2+config1-config1+24+256-(/*128+48*/sin(cos(256*scrw/2+config1)-(648+48))*256); //dividing for 2 + got strafeangle and multiplied by 2
					 semiStrafedone = false;
				 }
				 ptre.Y = get.Y; //get y position
